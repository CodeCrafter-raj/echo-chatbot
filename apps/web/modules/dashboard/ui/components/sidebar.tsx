...
import {Sidebar,SidebarContent,SidebarFooter,SidebarGroup,SidebarGroupContent, SidebarGroupLabel,
  SidebarHeader,SidebarMenu,SidebarMenuItem,SidebarMenuButton,SidebarRail
            ...
            <SidebarMenu>
              {customerSupportItems.map((item)=>(
                <SidebarMenuItem key={item.title} >
                  ...
                  className={cn(isActive(item.url) && "bg-gradient-to-b from-sidebar-primary !to-[#0b63f3] text-sidebar-foreground! hover:to-[#0b63f3]!"
                    )}
                  tooltip={item.title}>
                    <Link href={item.url}>
          ...
          <SidebarMenu>
            <SidebarMenuItem>
             ...
             appearance={{elements:{
              ...
              userButtonOuterIdentifier:"pl-0! group-data-[collapsibe=icon]:hidden!",
              avatarBox:"size-4!",
             }}}
